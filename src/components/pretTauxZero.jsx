      ...
      <Container fluid className="patzContainerFluid">
        <Row className="justify-content-center align-items-center" >
          ...
          <Col xs='11' md='8' lg='6' className="mb-3 mb-lg-0 py-lg-5 patzText">
            <a href="https://www.economie.gouv.fr/particuliers/emprunter-et-sassurer/pret-taux-zero-ptz-tout-ce-quil-faut-savoir" target="_blank" rel="noopener noreferrer">
